...
function symPolytabloidProduct(t1::AbstractAlgebra.Generic.YoungTableau{Int64}, t2::AbstractAlgebra.Generic.YoungTableau{Int64}, lambda::Vector{T} = Int8.(t1.part.part[1] > t2.part.part[1] ? t1.part.part : t2.part.part), limit = false) where {T}
